...
class CorrelatorPass(object):
    ...
    def flagged_weights(self, flagweight: FlagWeight):
        self._flagged_weights: FlagWeight | None = flagweight


    @property
    def freqsetup(self) -> Subbands | None:
    ...
    def freqsetup(self, new_freqsetup: Subbands):
        ...
        """
        self._freqsetup: Subbands | None = new_freqsetup
...
class Experiment(object):
    ...
    def timerange(self, times: tuple[dt.datetime, dt.datetime]):
        ...
        self._startime: dt.datetime | None = starttime
        self._endtime: dt.datetime | None = endtime
    ...
    def sources_stdplot(self, stdplot_sources: list[str]):
        self._src_stdplot: list[str] | None = copy.deepcopy(stdplot_sources)
    ...
    @last_step.setter
    def last_step(self, last_step: str | None):
        self._last_step: str | None = last_step
