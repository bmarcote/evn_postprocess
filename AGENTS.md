...
Each time you complete a task or learn important information about the project, you should update the `.codeium-instructions.md` file that might be in the project to reflect any new information that you've learned or changes that require updates to these instructions files.
...
1. Structure
- Use a consistent, predictable project layout following standard practices in the current language.
...
- Keep the text concise: write all parameters and elements in one line. Only split line if the line is longer than 120 characters.
- Write documentation for each function you write. Keep it up to date with the current inputs and outputs.
